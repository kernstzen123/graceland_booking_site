...
export default function AuditLog() {
  ...
  return <main className="container" style={{ padding: '2rem 1rem' }}>
    <div className="admin-header"><div><p style={{ color: 'var(--primary)', fontWeight: 700 }}>ACCOUNTABILITY</p><h1>Audit log</h1></div><Link className="btn" href="/admin" style={{ border: '1px solid var(--border-color)' }}>Dashboard</Link></div>
