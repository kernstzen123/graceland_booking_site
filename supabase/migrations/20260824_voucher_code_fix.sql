-- Follow-up for environments where 20260824_booking_vouchers.sql was already applied.
-- Avoids gen_random_bytes(), which is unavailable in some Supabase projects.
